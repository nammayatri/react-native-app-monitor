...
Make sure your `Podfile` has access to the private CocoaPods spec repository where `AppMonitor ~> 1.0.0` is hosted.

### Android Setup

The Android SDK (`com.movingtech:appmonitor:1.0.2@aar`) will be automatically resolved if your Maven repository is properly configured in your app's `build.gradle`.
