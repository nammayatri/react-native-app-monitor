...
export interface Spec extends TurboModule {
    ...
    addEvent(
        eventType: string,
        eventName: string,
        eventPayload: { [key: string]: string | number | boolean | { [key: string]: string | number | boolean } },
    ): void;
    addLog(logLevel: string, logMessage: string, tag: string, labels: { [key: string]: string }): void;
    getSessionId(): string;
